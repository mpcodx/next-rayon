...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        {isServicesOpen && (
          <>
            ...
            <div className="hidden lg:block absolute left-[11%] top-full mt-3 w-[min(94vw,64rem)] z-50 rounded-2xl glass-card border border-white/20 shadow-[0_24px_45px_rgba(2,6,23,0.55)]">
      ...
      {isOpen && (
        <div className="lg:hidden bg-slate-950/95 backdrop-blur-xl border-t border-white/10 overflow-hidden shadow-2xl">
              ...
              <div key={link.name}>
                {link.dropdown ? (
                  <div>
                    ...
                    {isServicesOpen && (
                      <div className="pl-2 pr-1 mt-2 space-y-2 max-h-[60vh] overflow-y-auto">
                        {services.map((item) => (
